      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="p-12">
            ...
            <p className="text-gray-300 max-w-3xl leading-relaxed">
              We provide high-quality electronic components designed to meet the demanding requirements of modern industries. Our solutions support reliability, performance, and long-term scalability across enterprise, industrial, and government applications.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Our electronic components are widely used in IT infrastructure, industrial automation, healthcare equipment, surveillance systems, smart cities, and government projects — ensuring reliability even in mission-critical environments.
          </p>
        </motion.div>
